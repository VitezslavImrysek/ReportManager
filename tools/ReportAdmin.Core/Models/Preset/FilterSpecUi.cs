...
public sealed class FilterSpecUi : NotificationObject
{
    ...
    public FilterOperation Operation { get; set => SetValue(ref field, value); }
    ...
    public static explicit operator FilterSpecJson(FilterSpecUi ui)
    {
        ...
        {
            ColumnKey = ui.ColumnKey,
            Operation = ui.Operation,
            Values = ui.Values.ToList()
        };
    }
    ...
    public static explicit operator FilterSpecUi(FilterSpecJson src)
    {
        ...
        return new FilterSpecUi
        {
            ColumnKey = src.ColumnKey,
            Operation = src.Operation,
            Values = new ObservableCollection<string>(src.Values)
        };
    }
}
